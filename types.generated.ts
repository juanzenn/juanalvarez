...
interface IndexDocumentData {
     ...
     *
     */
    body: prismicT.SliceZone<IndexDocumentDataBodySlice>;
}
/**
...
export type IndexDocumentDataBodyHeroaboutSlice = prismicT.Slice<"heroabout", Simplify<IndexDocumentDataBodyHeroaboutSlicePrimary>, never>;
/**
...
export interface IndexDocumentDataBodyProjectsSliceItem {
     ...
     *
     */
    project_title: prismicT.TitleField;
    /**
     ...
     *
     */
    project_type: prismicT.KeyTextField;
    /**
...
export type IndexDocumentDataBodyProjectsSlice = prismicT.Slice<"projects", Simplify<IndexDocumentDataBodyProjectsSlicePrimary>, Simplify<IndexDocumentDataBodyProjectsSliceItem>>;
/**
...
export interface IndexDocumentDataBodyBlogPostsSliceItem {
     ...
     *
     */
    blog: prismicT.RelationField<"blog_post">;
}
export type IndexDocumentDataBodyBlogPostsSlice = prismicT.Slice<"blog_posts", Simplify<IndexDocumentDataBodyBlogPostsSlicePrimary>, Simplify<IndexDocumentDataBodyBlogPostsSliceItem>>;
/**
...
export interface IndexDocumentDataBodyContactSliceItem {
     ...
     *
     */
    contact_label: prismicT.KeyTextField;
    /**
...
export type IndexDocumentDataBodyContactSlice = prismicT.Slice<"contact", Record<string, never>, Simplify<IndexDocumentDataBodyContactSliceItem>>;
/**
 * Slice for *Homepage → Slice zone*
 *
 */
type IndexDocumentDataBodySlice = IndexDocumentDataBodyHeroaboutSlice | IndexDocumentDataBodyProjectsSlice | IndexDocumentDataBodyBlogPostsSlice | IndexDocumentDataBodyContactSlice;
/**
 ...
 *
 */
export type IndexHeroSliceDefaultSlice = prismicT.SharedSliceVariation<"default-slice", Simplify<IndexHeroSliceDefaultSlicePrimary>, never>;
/**
 ...
 *
 */
export type IndexHeroSlice = prismicT.SharedSlice<"index_hero", IndexHeroSliceVariation>;
declare module "@prismicio/client" {
    interface CreateClient {
        (repositoryNameOrEndpoint: string, options?: prismic.ClientConfig): prismic.Client<AllDocumentTypes>;
    }
    namespace Content {
        export type { BlogPostDocumentData, BlogPostDocument, IndexDocumentData, IndexDocumentDataBodyHeroaboutSlicePrimary, IndexDocumentDataBodyHeroaboutSlice, IndexDocumentDataBodyProjectsSlicePrimary, IndexDocumentDataBodyProjectsSliceItem, IndexDocumentDataBodyProjectsSlice, IndexDocumentDataBodyBlogPostsSlicePrimary, IndexDocumentDataBodyBlogPostsSliceItem, IndexDocumentDataBodyBlogPostsSlice, IndexDocumentDataBodyContactSliceItem, IndexDocumentDataBodyContactSlice, IndexDocumentDataBodySlice, IndexDocument, AllDocumentTypes, IndexHeroSliceDefaultSlicePrimary, IndexHeroSliceDefaultSlice, IndexHeroSliceVariation, IndexHeroSlice };
    }
}
