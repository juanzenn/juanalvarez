...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 flex h-[56px] flex-col items-center justify-center border-b border-gray-50 border-opacity-25 bg-white py-2 shadow lg:flex-row lg:gap-8">
